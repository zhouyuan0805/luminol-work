...
def mean_std_series(filepath_list,ip_list, min = '5T', N1=2, N2=2):
    summary_series = []
    for i in range(len(filepath_list)):
        ...
        five_minute_data = test_series.resample(min, how='mean', closed='left')
    ...
    upper_series = mean_series + N1 * std_series
    down_series = mean_series - N2 * std_series
    return upper_series, down_series



upper_series, down_series = mean_std_series(filepath_list, ip_list, min='5T', N1=2, N2=2)
